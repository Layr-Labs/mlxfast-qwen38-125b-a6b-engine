...
enum TrackP12Prefill {
    ...
    /// Opt-in (TRACK_P12_REC_BOUNDARY=1): this variant measures the z-first
    /// binding without the 36 extra per-prefill command-buffer commits.
    static let recurrenceBoundary =
        master && ProcessInfo.processInfo.environment["TRACK_P12_REC_BOUNDARY"] == "1"
