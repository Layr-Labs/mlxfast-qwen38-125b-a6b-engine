// Copyright © 2025 Apple Inc. Adapted from the vendored MLX gemm_nax.h.
// Licensed under the MIT license; see Vendor/mlx-swift/Source/Cmlx/mlx/LICENSE.

extension TrackPrefillRouter {
    static let loopHeader = #"""
template <
    typename StorageT,
    short SM,
    short SN,
...
auto track_router_loop(
    const device StorageT* A,
    const device StorageT* B,
    int lda,
    int ldb,
    int K,
