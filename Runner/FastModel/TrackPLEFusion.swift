...
enum TrackPLEFusion {
    ...
    static let convolutionSource = """
        // MLXFAST-PLEFUSE3: one thread per channel. The S=1 dilated conv is
        // 10240 independent 4-tap dots; the implicit-GEMM-shaped dispatch
        // spent a 128-thread threadgroup on each and broadcast the taps
        // across a simdgroup. The per-channel arithmetic is unchanged: FP32
        // products and chronological FP32 additions, taps 0,1,2,3, one
        // rounding into InT, the same silu and residual add.
