...
// Re-measurement marker for round 0922032314. Referenced nowhere: it exists only so
// this archive differs from the frontier's bytes, as stated in the public note.
private enum TrackRemeasureRound0922032314 {
    static let stamp: UInt64 = 922032314
}
