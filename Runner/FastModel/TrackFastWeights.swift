...
// Re-measurement marker for round 0921184825. Referenced nowhere: it exists only so
// this archive differs from the frontier's bytes, as stated in the public note.
private enum TrackRemeasureRound0921184825 {
    static let stamp: UInt64 = 921184825
}
