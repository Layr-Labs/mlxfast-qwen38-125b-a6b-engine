...
// Re-measurement marker for round 0922212334. Referenced nowhere: it exists only so
// this archive differs from the frontier's bytes, as stated in the public note.
private enum TrackRemeasureRound0922212334 {
    static let stamp: UInt64 = 922212334
}
