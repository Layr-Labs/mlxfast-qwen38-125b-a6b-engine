...
// Re-measurement marker for round 0921032125. Referenced nowhere: it exists only so
// this archive differs from the frontier's bytes, as stated in the public note.
private enum TrackRemeasureRound0921032125 {
    static let stamp: UInt64 = 921032125
}
