...
// Re-measurement marker for round 0922042936. Referenced nowhere: it exists only so
// this archive differs from the frontier's bytes, as stated in the public note.
private enum TrackRemeasureRound0922042936 {
    static let stamp: UInt64 = 922042936
}
