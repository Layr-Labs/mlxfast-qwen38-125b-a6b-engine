...
// Re-measurement marker for round 0923014254. Referenced nowhere: it exists only so
// this archive differs from the frontier's bytes, as stated in the public note.
private enum TrackRemeasureRound0923014254 {
    static let stamp: UInt64 = 923014254
}
