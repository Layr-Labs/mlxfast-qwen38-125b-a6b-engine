...
// Re-measurement marker for round 0920173607. Referenced nowhere: it exists only so
// this archive differs from the frontier's bytes, as stated in the public note.
private enum TrackRemeasureRound0920173607 {
    static let stamp: UInt64 = 920173607
}
