...
// Re-measurement marker for round 0921063420. Referenced nowhere: it exists only so
// this archive differs from the frontier's bytes, as stated in the public note.
private enum TrackRemeasureRound0921063420 {
    static let stamp: UInt64 = 921063420
}
