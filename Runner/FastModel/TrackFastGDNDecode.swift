...
enum TrackFastGDNDecode {
    ...
    private static let source = #"""
        ...
        // MLXFAST-JRNHOIST: the pending-decay entry is indexed by hv_idx and
        // the pending-key entries by hv_idx/lane only — neither depends on the
        // row loop, and journal_in is never written in this kernel. Load both
        // once per simdgroup instead of once per row.
