...
enum TrackFastGDNDecode {
    ...
    private static let source = #"""
        ...
        // Per channel the arithmetic is unchanged -- same KC-term walk, same
        // InT cast, same silu, same float cast -- only which simdgroup runs it
        // and where the result lands change. Bit-identical by construction.
