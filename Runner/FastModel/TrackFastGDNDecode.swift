...
enum TrackFastGDNDecode {
    ...
    static func apply(
        ...
        // nothing here rebinds; it was evaluated four more times below. Bind
        // it once. Host-side only: the same DType reaches the same template
        // slot and the same output descriptors.
