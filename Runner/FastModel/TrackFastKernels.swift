...
enum TrackFastKernels {
    ...
    static func runtimeTSource(_ source: String) -> String {
        let old = "const int T_ = T;"
        let next = source.replacingOccurrences(of: old, with: "const int T_ = tlen;")
    ...
    static func gdnRecurrence(
        ...
        if !useT { inputs.append(intScalar(Int32(T))) }
