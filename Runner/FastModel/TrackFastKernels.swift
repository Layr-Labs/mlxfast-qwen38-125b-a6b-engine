...
enum TrackFastKernels {
    ...
    static let prepSource = """
        ...
        for (int i = 0; i < N_READS; ++i) {
            ...
            // The table was generated by this same typed sigmoid helper.
            InT c1;
    ...
    nonisolated(unsafe) static let prepKernel = MLXFast.metalKernel(
        name: "track_gdn_prep",
        inputNames: ["proj", "conv_state", "conv_w", "neg_exp_alog", "dt_bias", "sigmoid_lut"],
    ...
    static func gdnPrep(
        ...
        return prepKernel(
            [proj, convState, convW, negExpALog, dtBias, sigmoidTable],
            template: [
