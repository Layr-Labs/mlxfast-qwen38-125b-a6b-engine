...
extension TrackFastMoEKernels {
    ...
    // Second measurement of submission 63106e0f: identical kernel bytes to the
    // artifact that scored 1.99462295383668; this marker only distinguishes the
    // archive from the deduplicated upload.
