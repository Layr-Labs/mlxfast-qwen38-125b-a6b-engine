...
extension TrackFastMoEKernels {
    ...
    static let downCombineSource = """
        ...
        if (sgi == (EXTRA_SHARED_SG ? (uint)KSG : 0u)) {
    ...
    static func downCombine(
        ...
        let extraSharedSimdgroup = S == 1
        let threadgroupSimdgroups = ksg + (extraSharedSimdgroup ? 1 : 0)
        return (S == 1 ? downCombineKernel1 : downCombineKernel)(
            ...
            template: [("T", act.dtype), ("GS", groupSize), ("BITS", bits), ("H", H), ("F", F), ("K", topK), ("FAST", isFast(k: F, n: H)), ("BR", BR), ("VPT", S), ("KSG", ksg), ("RPS", rps), ("EXTRA_SHARED_SG", extraSharedSimdgroup)],
            grid: (32, (H / rps) * threadgroupSimdgroups, S), threadGroup: (32, threadgroupSimdgroups, 1),
