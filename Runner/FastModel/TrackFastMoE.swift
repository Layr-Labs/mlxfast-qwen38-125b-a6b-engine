...
extension TrackFastMoEKernels {
    ...
    {
        precondition(logits.dtype == .float32 && sharedGate.rows == 1 && sharedGate.bits == 4)
        ...
        let outs = routeKernel(
            [logits.reshaped(R, E), x.reshaped(R, KD), sharedGate.weight, sharedGate.scales, sharedGate.biases!],
            template: [("E", E), ("K", topK), ("T", x.dtype), ("GS", sharedGate.groupSize), ("BITS", sharedGate.bits), ("KD", KD), ("VPT", R)],
