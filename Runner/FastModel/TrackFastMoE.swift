...
extension TrackFastMoEKernels {
    ...
    static func downCombine(
        ...
        let fastDown = isFast(k: F, n: H)
        precondition(act.dim(0) == BR + S && gate.dim(0) == S && sharedDown.rows == H && !fastDown)
        ...
        return (S == 1 ? downCombineKernel1 : downCombineKernel)(
            ...
            template: [("T", act.dtype), ("GS", groupSize), ("BITS", bits), ("H", H), ("F", F), ("K", topK), ("FAST", fastDown), ("BR", BR), ("VPT", S), ("KSG", ksg), ("RPS", rps)],
