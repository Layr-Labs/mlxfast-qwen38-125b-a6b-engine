...
public final class TrackQwen4ExpInlineMTPAssistant {
    ...
    private func headStep(
        ...
        // Score the complete pinned vocabulary. A static low-ID subset can
        // exclude the native head's preferred proposal before verification.
        let draft = argMax(
            target.head(lastSample)[0..., -1, 0...], axis: -1).asType(.int32)
